...
//返回是 [{"description":"foo thing","name":"foo"},{"description":"bar thing","name":"bar"}]
...
//返回 [{"description":"foo thing","name":"foo"},{"description":"bar thing","name":"bar"}]
...
//返回 {"p1":"P2","p2":"P2","q":"qqq","x":"xxx","y":"yyy"}
